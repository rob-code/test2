...
<Hero
    content={{
        image: flipflops,
        text: "Print Sizes and Framing",
        alt: "information on print sizes",
    }}
/>
...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <th scope="row">Small Print</th>
                <td>210</td>
                <td>326</td>
            </tr>
            <tr>
                <th scope="row">Small Print + Border</th>
                <td>270</td>
                <td>366</td>
            </tr>
            <tr>
                <th scope="row">Medium Print</th>
                <td>297</td>
                <td>462</td>
            </tr>
            <tr>
                <th scope="row">Medium Print + Border</th>
                <td>357</td>
                <td>502</td>
            </tr>
        </tbody>
