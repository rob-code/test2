   ...
   <section class="container">
    ...
    <div class="bg-body-tertiary">
      ...
      <div class="row project-pages-next-page">
        ...
        <div class="col">
          <p class="text-end" style="padding-right:4%"><a href="{base}/projects/everyday_icons" class="link-black">Everyday Icons <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 20 20">
