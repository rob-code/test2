...
<div class="container">
  <div class="display-6 page-title">Terms of Service</div>

  <p class="display-6 policy-title">OVERVIEW</p>

  <p class="policy-text">
    This website is operated by Robert Brice Art. Throughout the site, the terms
    “we”, “us” and “our” refer to Robert Brice Art. Robert Brice Art offers this
  ...
  <p class="display-6 policy-title">SECTION 1 - ONLINE STORE TERMS</p>
  ...
  <p class="display-6 policy-title">SECTION 2 - GENERAL CONDITIONS</p>
  ...
  <p class="display-6 policy-title">
  ...
  <p class="display-6 policy-title">SECTION 7 - OPTIONAL TOOLS</p>
  ...
  <p class="display-6 policy-title">SECTION 8 - THIRD-PARTY LINKS</p>

  <p class="policy-text">
    Certain content, products and services available via our Service may include
    materials from third-parties. Third-party links on this site may direct you
  ...
  <p class="display-6 policy-title">SECTION 10 - PERSONAL INFORMATION</p>
  ...
  <p class="display-6 policy-title">SECTION 12 - PROHIBITED USES</p>
  ...
  <p class="policy-text">
    In no case shall Robert Brice Art, our directors, officers, employees,
  ...
  <p class="display-6 policy-title">SECTION 14 - INDEMNIFICATION</p>

  <p class="policy-text">
    You agree to indemnify, defend and hold harmless Robert Brice Art and our
  ...
  <p class="display-6 policy-title">SECTION 15 - SEVERABILITY</p>
  ...
  <p class="display-6 policy-title">SECTION 16 - TERMINATION</p>
  ...
  <p class="display-6 policy-title">SECTION 17 - ENTIRE AGREEMENT</p>
  ...
  <p class="display-6 policy-title">SECTION 18 - GOVERNING LAW</p>
  ...
  <p class="display-6 policy-title">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
  ...
  <p class="display-6 policy-title">SECTION 20 - CONTACT INFORMATION</p>

  <p class="policy-text">
    Questions about the Terms of Service should be sent to us using our contact
    page.
  </p>
</div>
